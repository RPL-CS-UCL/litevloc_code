...
<div align="center">
    <a href="">
      <img src="media/ins_simu_results.png" width="30%" 
      alt="ins_simu_matterport3d_environment">
    </a>
    <a href="">
      <img src="media/ins_simu_matterport3d_rviz.png" width="42%" 
...
2. Run the visual localization
    ...
    roslaunch topo_loc run_vloc_online_simuenv.launch env_id:=17DRP5sb8fy map_path:=data_topo_loc/matterport3d/vloc_17DRP5sb8fy/out_map/
    ```
3. Run the iPlanner
    ```
...
<div align="center">
    <a href="">
      <img src="media/ins_simu_results.png" width="70%" 
